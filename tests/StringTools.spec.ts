...
describe('StringTools', () => {
  describe('capitalise', () => {
    it(`exists as 'StringTools.capitalise'`, () => {
      expect(swissak.StringTools.capitalise).toBeDefined();
    });
  });
  describe('angloise', () => {
    it(`exists as 'StringTools.angloise'`, () => {
      expect(swissak.StringTools.angloise).toBeDefined();
    });
  });
  describe('clean', () => {
    it(`exists as 'StringTools.clean'`, () => {
